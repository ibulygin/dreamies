...
function jsTask() {
    return src(['index.js'].map(s => join('src/scripts', s)))
...
module.exports = {
    serve: series(clean, parallel(htmlTask, cssTask, imgTask, jsTask, fonts), serve),
    default: series(enableProd, clean, parallel(htmlTask, cssTask, imgTask, jsTask, fonts))
};